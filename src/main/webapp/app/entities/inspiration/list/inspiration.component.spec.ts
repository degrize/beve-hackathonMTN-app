...
describe('Inspiration Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'inspiration', component: InspirationComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inspirations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to inspirationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInspirationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInspirationIdentifier).toHaveBeenCalledWith(entity);
