...
type RestOf<T extends ITransaction | NewTransaction> = Omit<T, 'dateTransaction'> & {
...
export class TransactionService {
  ...
  protected convertDateFromServer(restTransaction: RestTransaction): ITransaction {
    return {
      ...restTransaction,
      dateTransaction: restTransaction.dateTransaction ? dayjs(restTransaction.dateTransaction) : undefined,
    };
  }
