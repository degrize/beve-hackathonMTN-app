...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'categorie-createur',
        data: { pageTitle: 'beveApp.categorieCreateur.home.title' },
        loadChildren: () => import('./categorie-createur/categorie-createur.module').then(m => m.CategorieCreateurModule),
      },
      {
        path: 'transaction',
