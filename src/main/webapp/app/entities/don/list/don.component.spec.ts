...
describe('Don Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'don', component: DonComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to donService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDonIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDonIdentifier).toHaveBeenCalledWith(entity);
