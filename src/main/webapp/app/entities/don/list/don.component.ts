...
import { EntityArrayResponseType, DonService } from '../service/don.service';
...
export class DonComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDon): number => this.donService.getDonIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.dons = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDon[] | null): IDon[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.donService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
