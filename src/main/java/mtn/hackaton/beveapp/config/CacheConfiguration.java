package mtn.hackaton.beveapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mtn.hackaton.beveapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mtn.hackaton.beveapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
