...
/**
 * REST controller for managing {@link mtn.hackaton.beveapp.domain.Souscription}.
 */
@RestController
@RequestMapping("/api")
public class SouscriptionResource {
    ...
    public ResponseEntity<List<SouscriptionDTO>> getAllSouscriptions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Souscriptions");
        Page<SouscriptionDTO> page = souscriptionService.findAll(pageable);
