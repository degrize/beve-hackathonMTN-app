...
import mtn.hackaton.beveapp.repository.TransactionRepository;
import mtn.hackaton.beveapp.service.dto.TransactionDTO;
import mtn.hackaton.beveapp.service.mapper.TransactionMapper;
...
class TransactionResourceIT {
    ...
    private static final String DEFAULT_NUMERO_MTN = "AAAAAAAAAA";
    private static final String UPDATED_NUMERO_MTN = "BBBBBBBBBB";

    private static final Double DEFAULT_MONTANT = 1D;
    private static final Double UPDATED_MONTANT = 2D;

    private static final Devise DEFAULT_DEVISE = Devise.EURO;
    private static final Devise UPDATED_DEVISE = Devise.CEDI;
    ...
    void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getNumeroMtn()).isEqualTo(DEFAULT_NUMERO_MTN);
        assertThat(testTransaction.getMontant()).isEqualTo(DEFAULT_MONTANT);
        assertThat(testTransaction.getDevise()).isEqualTo(DEFAULT_DEVISE);
        assertThat(testTransaction.getDateTransaction()).isEqualTo(DEFAULT_DATE_TRANSACTION);
    }
    ...
    @Test
    @Transactional
    void checkNumeroMtnIsRequired() throws Exception {
        int databaseSizeBeforeTest = transactionRepository.findAll().size();
        // set the field null
        transaction.setNumeroMtn(null);
    ...
    void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc
            ...
            .andExpect(jsonPath("$.[*].numeroMtn").value(hasItem(DEFAULT_NUMERO_MTN)))
    ...
    void getTransaction() throws Exception {
        ...
        restTransactionMockMvc
            ...
            .andExpect(jsonPath("$.numeroMtn").value(DEFAULT_NUMERO_MTN))
    ...
    void putNewTransaction() throws Exception {
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getNumeroMtn()).isEqualTo(UPDATED_NUMERO_MTN);
        assertThat(testTransaction.getMontant()).isEqualTo(UPDATED_MONTANT);
        assertThat(testTransaction.getDevise()).isEqualTo(UPDATED_DEVISE);
        assertThat(testTransaction.getDateTransaction()).isEqualTo(UPDATED_DATE_TRANSACTION);
    }
    ...
    void partialUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.montant(UPDATED_MONTANT);
